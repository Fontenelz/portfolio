    ...
    <section id="experience" className="mb-32 scroll-mt-20">
      ...
      <div className="max-w-4xl">
        <div className="relative pl-4">
          <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-[#233554]" />
          <div className="space-y-12">
            {EXPERIENCES.map((exp, index) => (
              <div key={exp.id} className="relative pl-8">
                <div className="absolute left-[-20px] top-1 w-3 h-3 bg-[#64ffda] rounded-full border-4 border-[#0a192f]" />
                <div className="mb-2">
                  ...
                  <p className="text-sm text-[#8892b0] font-mono mb-3">
                    {exp.period}
                  </p>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {exp.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 text-xs font-mono text-[#64ffda] bg-[#112240] rounded"
                    >
                      {tech}
                    </span>
                  ))}
